...
public class Laboratorio3 {
	...
	public void registroUsuario() throws IOException {
		...
		email.sendKeys("correo27318mane1234@prueba.com");
		
		//captura de imagen
		File screen=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screen,new File("..\\Educacionit1\\Evidencias\\01_ingreso_del_correo.png"));
		...
		//Captura de formulario lleno
		screen=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screen,new File("..\\Educacionit1\\Evidencias\\02_formulario_lleno.png"));
		...
		//capturo de vuelta
		screen=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screen,new File("..\\Educacionit1\\Evidencias\\03_resultado_del_registro.png"));
